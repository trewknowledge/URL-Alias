...
const UrlAlias = ({postType, postMeta, setPostMeta}) => {
	...
	return (
		<PluginDocumentSettingPanel name="tk-url-alias" title="URL Alias" className="tk-url-alias">
			<PanelRow>
				<TextControl
					...
					help={ __( 'Specify an alternative path for your posts and pages', 'tk-url-alias' ) }
				/>
			</PanelRow>
